    ...
    (
        ...
        return (
            ...
            >
                <div
                    className={cn(
                        'min-h-10 rounded-md border border-input bg-background text-sm transition duration-200 focus-within:border-primary/70 focus-within:ring focus-within:ring-ring',
                        {
                ...
                <div className='relative mt-1'>
                    {open && (
                        <Command.List className='absolute top-1 z-10 w-full rounded-md border bg-popover text-popover-foreground shadow-md outline-none animate-in'>
                            {isLoading ? (
                                <>{loadingIndicator}</>
                            ) : (
                                <>
